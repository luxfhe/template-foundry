...
# Rename instances of "luxfheprotocol/luxfhe-foundry-template" to the new repo name in README.md for badges only
sedi "/gitpod/ s|luxfheprotocol/luxfhe-foundry-template|"${GITHUB_REPOSITORY}"|;" "README.md"
sedi "/gitpod-badge/ s|luxfheprotocol/luxfhe-foundry-template|"${GITHUB_REPOSITORY}"|;" "README.md"
sedi "/gha/ s|luxfheprotocol/luxfhe-foundry-template|"${GITHUB_REPOSITORY}"|;" "README.md"
sedi "/gha-badge/ s|luxfheprotocol/luxfhe-foundry-template|"${GITHUB_REPOSITORY}"|;" "README.md"
